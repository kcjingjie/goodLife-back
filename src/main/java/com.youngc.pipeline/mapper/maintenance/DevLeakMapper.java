...
public interface DevLeakMapper {
     ...
     * @return
     */
    @Select("SELECT id,dev_id,device_name,leak_no,leak_degree,occur_time,plan_exe_time,handle_method FROM dev_leak_manager dlm "+
     ...
     * @return
     */
    @Insert(" INSERT INTO dev_leak_manager (dev_id, leak_no,leak_degree,occur_time,plan_exe_time,handle_method,remark,add_person, add_time, last_person, last_time)" +
            " VALUES( #{devId}, #{leakNo},#{leakDegree}, #{occurTime},#{planExeTime},#{handleMethod},#{remark},#{addPerson}, now(), #{lastPerson}, now())")
     ...
     * @return
     */
    @Select(" SELECT id,dev_id, leak_no,leak_degree,occur_time,plan_exe_time,handle_method,remark" +
